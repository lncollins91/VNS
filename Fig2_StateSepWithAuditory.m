...
% avWF_Aud1_stationary = [];
% avWF_Barrel_stationary = [];
...
%         this_avWF_Aud1 = (avWF_Aud1(:,i));
%         this_avWF_Barrel = (avWF_Barrel(:,i));
%         
...
%         avWF_Aud1_walking = [avWF_Aud1_walking, this_avWF_Aud1];
%         avWF_Barrel_walking = [avWF_Barrel_walking, this_avWF_Barrel];
%                 
...
%         avWF_Aud1_stationary = [avWF_Aud1_stationary, this_avWF_Aud1];        
%         avWF_Barrel_stationary = [avWF_Barrel_stationary, this_avWF_Barrel];
    end
end
...
%         this_avWF_Aud1 = (avWF_Aud1_stationary(:,i));
%         this_avWF_Barrel = (avWF_Barrel_stationary(:,i));
%         
...
%         avWF_Aud1_whisk = [avWF_Aud1_whisk, this_avWF_Aud1];
%         avWF_Barrel_whisk = [avWF_Barrel_whisk, this_avWF_Barrel];
%                 
...
%         avWF_Aud1_still = [avWF_Aud1_still, this_avWF_Aud1];
%         avWF_Barrel_still = [avWF_Barrel_still, this_avWF_Barrel];
    end
end
...
% dsavWF_Aud1=downsample(avWF_Aud1,300);
% dsavWF_Barrel=downsample(avWF_Barrel,300);
...
% dsavWF_Aud1_walking=downsample(avWF_Aud1_walking,300);
% dsavWF_Barrel_walking=downsample(avWF_Barrel_walking,300);
...
% dsavWF_Aud1_whisk=downsample(avWF_Aud1_whisk,300);
% dsavWF_Barrel_whisk=downsample(avWF_Barrel_whisk,300);
...
% dsavWF_Aud1_still=downsample(avWF_Aud1_still,300);
% dsavWF_Barrel_still=downsample(avWF_Barrel_still,300);
...
subplot(8,2,10);
stdshade(dsavWF_Aud1',0.2,'k',dstime')
title('Auditory')
ylim([-0.02 0.25])
xlim([4 11])

subplot(8,2,11);
stdshade(dsavWF_Barrel',0.2,'k',dstime')
title('Barrel')
ylim([-0.02 0.25])
xlim([4 11])
...
subplot(8,2,10);
stdshade(dsavWF_Aud1_still',0.2,'k',dstime')
title('Auditory')
ylim([-0.02 0.25])
xlim([4 11])

subplot(8,2,11);
stdshade(dsavWF_Barrel_still',0.2,'k',dstime')
title('Barrel')
ylim([-0.02 0.25])
xlim([4 11])
...
figure(7);
suptitle('Walking/Whisking') 
set(gcf,'color','w');
set(gcf,'Position',[100 100 800 800])

subplot(8,2,10);
stdshade(dsavWF_Aud1_whisk',0.2,'k',dstime')
title('Auditory')
ylim([-0.02 0.25])
xlim([4 11])

subplot(8,2,11);
stdshade(dsavWF_Barrel_whisk',0.2,'k',dstime')
title('Barrel')
ylim([-0.00 0.27])
xlim([4 11])
